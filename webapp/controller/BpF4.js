sap.ui.define([
	...
	return ManagedObject.extend("com.sap.build.standard.businessPartnerCustomerGroupAssignment.controller.BpF4", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.standard.businessPartnerCustomerGroupAssignment.view.BpF4", this);
			this._bInit = false;
		},
