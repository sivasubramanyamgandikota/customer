sap.ui.define([
	...
	return ManagedObject.extend("com.sap.build.standard.businessPartnerCustomerGroupAssignment.controller.CityF4", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.standard.businessPartnerCustomerGroupAssignment.view.CityF4", this);
			this._bInit = false;
		},
		...
		_onSelectDialogLiveChange: function(oEvent) {
			var sControlId = "sap_m_SelectDialog_5";
